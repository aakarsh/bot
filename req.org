...
5 Animal is at an appropriate scale (the size of 1-3 grid cells of the terrain).
10 Animal is at the correct height to stand on the terrain. This does not need to be perfect, but the body of the animal should be just above the terrain, while the legs (or other apendeges) should be touching the terrain. Moslty submerged or obviously floating positions will not get full credit.
